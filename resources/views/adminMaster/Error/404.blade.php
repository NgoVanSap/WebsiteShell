                    ...
                    <div class="col-md-8 text-center">
                        <div class="error-text">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                x="0px" y="0px" width="100%" height="100%" viewBox="0 0 398.1 226.6"
                                style="enable-background:new 0 0 398.1 226.6;" xml:space="preserve">
                                ...
                                <g id="OBJECTS">
                                    ...
                                    c-28.1-25.2-68.7,4.8-97.3,14.2C140.7,39.6,92.8,52.6,45.6,67.8z">
                                        ...
                                        <ellipse transform="matrix(0.9914 0.1307 -0.1307 0.9914 28.4406 -25.947)"
                                            class="st5" cx="211.9" cy="203.7" rx="11.2" ry="6.3">
                                        </ellipse>
                                        <g>
                                        ...
                                        <g>
                                            ...
                                            <ellipse transform="matrix(0.8917 -0.4527 0.4527 0.8917 -64.7638 91.5674)"
                                                class="st5" cx="158.9" cy="181.1" rx="15.7" ry="7">
                                            </ellipse>
                                            <path class="st11"
                                        ...
                                        <g>
                                            ...
                                            <ellipse transform="matrix(0.8479 0.5301 -0.5301 0.8479 134.9254 -109.8333)"
                                                class="st5" cx="258.9" cy="180.2" rx="10.6" ry="4.7">
                                            </ellipse>
                                            <path class="st11"
                            ...
                            <a href="{{ route('home.admin') }}" class="btn btn-round btn-primary mt-3">Back to Home</a>
                        </div>
                    </div>
                </div>
            </div>
