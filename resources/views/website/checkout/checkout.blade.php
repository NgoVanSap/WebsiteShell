            ...
            <form action="{{ route('postBillCartProduct.website') }}" method="post">
                ...
                <div class="row">
                        ...
                        <div class="main-input single-cart-form padding60">
                            ...
                            <div class="custom-input margin-boo">
                                <div class="margin-bottom-register">
                                    <input type="text" name="bill_name" value="{{ Auth::guard('customer')->user()->usernameCus }}" placeholder="Họ và tên...">
                                    <span class="text-danger error-text bill_name_error"></span>
                                </div>
                                <div class="margin-bottom-register">
                                    <input type="text" name="bill_email"value="{{ Auth::guard('customer')->user()->emailCus }}" placeholder="Email của bạn...">
                                     <span class="text-danger error-text bill_email_error"></span>
                                </div>
                                <div class="margin-bottom-register">
                                    <input type="text" name="bill_phone"value="{{ Auth::guard('customer')->user()->phoneCus }}" placeholder="Số điện thoại...">
                                    <span class="text-danger error-text bill_phone_error"></span>
                                </div>
                                <div class="margin-bottom-register">
                                    <div class="custom-mess">
                                        <textarea rows="2" placeholder="Địa chỉ" id="bill_address" name="bill_address"></textarea>
                                    <span class="text-danger error-text bill_address_error"></span>
                                    </div>
                                </div>
                                <div class="margin-bottom-register">
                                    <div class="custom-mess">
                                        <textarea rows="2" placeholder="Ghi chú..." id="bill_note" name="bill_note"></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="padding60">
                            <div class="log-title">
                                <h3><strong>Đơn đặt hàng</strong></h3>
                            </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;padding-right: 0 !important;"> {{$productViewCarts->cart_attribute_size }}</td>
                        ...
                        <div class="padding60">
                            ...
                            <div class="categories">
                                        ...
                                        <div class="" style=" border: 1px solid #cecdcd; background: #fff; background-clip: padding-box; border-radius: 5px; color: #545454; ">
                                            <div style="padding: 20px 20px 20px 15px;display: flex;align-items: center;">
                                                ...
                                                <label for="paymentMethod-368068" style="display: flex;margin-bottom: 0 !important;cursor: pointer;">
                                                    <span style=" margin-left: 9px;">Nhận hàng thanh toán (COD)</span>
                                ...
                                <div class="submit-text">
                                    <button type="submit" id="checkoutBill" class="btn-checkoutBill">Đặt hàng</button>
                                </div>
                            </div>
                        </div>
                    </div>
